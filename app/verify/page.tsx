...
import { ArrowLeft, QrCode, CheckCircle, XCircle, AlertCircle, User } from 'lucide-react';
...
export default function VerifyPage() {
  ...
  const handleManualVerification = () => {
    ...
    try {
      ...
      setTimeout(() => {
        const isValid = data.uin && data.uin.startsWith('PNG') && data.type === 'sevispass';
  ...
  const renderVerificationResult = () => {
    ...
    return (
      <div style={{
        ...
        borderRadius: '16px',
        padding: '32px',
        border: `2px solid ${verificationResult.valid ? 'var(--success)' : 'var(--destructive)'}`,
        marginTop: '24px'
      }}>
        <div style={{ 
          display: 'flex', 
          ...
          <h3 style={{ 
            ...
            fontWeight: '600', 
            margin: 0,
            color: verificationResult.valid ? 'var(--success)' : 'var(--destructive)'
          }}>
        ...
        {verificationResult.valid && verificationResult.data ? (
          <div>
            <div style={{
              ...
              <div>
                <h4 style={{ fontSize: '14px', fontWeight: '600', color: 'var(--muted-foreground)', marginBottom: '4px', textTransform: 'uppercase' }}>
                  Full Name
                </h4>
              ...
              <div>
                ...
                <p style={{ 
                  ...
                  fontWeight: '600', 
                  margin: 0,
                  color: verificationResult.data.status === 'active' ? 'var(--success)' : 'var(--warning)',
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', margin: 0 }}>
                  {new Date(verificationResult.data.issued).toLocaleDateString()}
                </p>
              </div>
            </div>
          ...
          <div style={{
            ...
            <p style={{ margin: 0, fontSize: '14px', color: 'var(--destructive)' }}>
              {verificationResult.error || 'Invalid or corrupted SevisPass data.'}
            </p>
          </div>
        )}
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          <p style={{ 
            ...
            Verify SevisPass digital identities by scanning QR codes or entering UIN numbers
          </p>
        </div>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              width: '100%',
              padding: '16px 24px',
              backgroundColor: loading || !qrInput.trim() ? '#9CA3AF' : 'var(--primary)',
              color: 'white',
              border: 'none',
              borderRadius: '12px',
              fontSize: '16px',
        ...
        <div style={{
          ...
          <ul style={{ margin: 0, paddingLeft: '20px' }}>
            <li><strong>QR Code:</strong> Copy and paste the full QR code data from a SevisPass card</li>
            <li><strong>UIN:</strong> Enter a 13-character UIN starting with "PNG" (e.g., PNG1234567890)</li>
            <li><strong>Mobile:</strong> Use your device camera to scan QR codes directly (coming soon)</li>
            <li><strong>Verification:</strong> Valid SevisPass cards show green status with user details</li>
          </ul>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: 'monospace', fontSize: '12px', background: 'var(--muted)', padding: '12px', borderRadius: '6px' }}>
            <strong>Sample UIN:</strong> PNG1234567890<br/>
            <strong>Sample QR Data:</strong><br/>
